...
admin.site.site_header = "A11"
admin.site.site_title = "A11 Admin Portal"
admin.site.index_title = "A11 Admin"

# swagger
api_info = openapi.Info(
    title="A11 API",
    default_version="v1",
    description="API documentation for A11 App",
)
